...
import tz.go.moh.him.emr.mediator.elmis.orchestrator.DefaultOrchestrator;
...
public class DefaultOrchestratorTest {
    ...
    public void testMediatorHTTPRequest() throws Exception {
        new JavaTestKit(system) {{
            final MediatorConfig testConfig = new MediatorConfig("emr-mediator-elmis", "localhost", 3016);
